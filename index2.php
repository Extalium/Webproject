...
printf('
  ...
  <html lang="en">
	...
	<head>
	  ...
	  <!-- Bootstrap core CSS -->
	  <link href="vendor/twbs/bootstrap/css/bootstrap-less.css" rel="stylesheet">
	...
	<body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light bg-faded py-lg-4">
		<div class="container">
			<!--a remplaclé par <?php include("toolbar.php"); ?> -->
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav mx-auto">
			  <li class="nav-item active px-lg-4">
				<a class="nav-link text-uppercase text-expanded" id="index">Home
				  <span class="sr-only">(current)</span>
				</a>
			  </li>
			  <li class="nav-item px-lg-4">
				<a class="nav-link text-uppercase text-expanded" id="personnality">Personnality</a>
			  </li>
			  <li class="nav-item px-lg-4">
				<a class="nav-link text-uppercase text-expanded" id="Login">Login</a>
			  </li>
			  <li class="nav-item px-lg-4">
				<a class="nav-link text-uppercase text-expanded" id="contact">Contact</a>
			  </li>
			</ul>
		  </div>
		</div>
