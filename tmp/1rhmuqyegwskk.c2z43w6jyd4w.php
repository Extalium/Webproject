...
<body>
	<div class="fixed-top">
		...
		<div class="tagline-lower text-center text-expanded text-shadow text-uppercase text-white mb-5 d-none d-lg-block js-scroll-trigger">3481 Melrose Place | Beverly Hills, CA 90210 | 123.456.7890</div>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item active px-lg-4">
							<a class="nav-link text-uppercase text-expanded" href="personnality.php">Personnality
